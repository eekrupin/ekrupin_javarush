...
public class Solution {
    public static void main(java.lang.String[] args) {
        ...
        try {
            ...
            if (object.string1.number==loadedObject.string1.number) System.out.println("string1number - ok");
            else System.out.println("string1number - false");

            if (object.string2.number == loadedObject.string2.number) System.out.println("string2number - ok");
            else System.out.println("string2number - false");
    ...
    public static class Object {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            printWriter.println(countStrings);
            printWriter.flush();
        }
