...
public class Solution {
    ...
    public static class AmigoThreadFactory implements ThreadFactory {
        ...
        public Thread newThread(Runnable r) {
            ...
            nameThread.append(threadGroup.getName());
            nameThread.append("-pool-");
            nameThread.append(currentPool);
            nameThread.append("-thread-");
            nameThread.append(numOfThreads.get());

            Thread thread = new Thread(r, nameThread.toString());
