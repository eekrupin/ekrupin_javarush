...
public class University {
    ...
    public Student getStudentWithMaxAverageGrade() {
        ...
        for (Student student : students) {
            if (studentWithMaxAverageGrade==null||student.getAverageGrade()>studentWithMaxAverageGrade.getAverageGrade())
    ...
    public Student getStudentWithMinAverageGrade() {
        ...
        for (Student student : students) {
            if (studentWithMinAverageGrade==null||student.getAverageGrade()<studentWithMinAverageGrade.getAverageGrade())
