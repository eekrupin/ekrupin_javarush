...
public class Solution {
    ...
    public static Object convertOneToAnother(Object one, Class resultClassObject) throws IOException {
        ...
        source.writeValue(stringWriter, one);
        ...
        String s = stringWriter.toString().replaceFirst(oneClass, secondClass);

        ObjectMapper destination = new ObjectMapper();
        Object o = destination.readValue(s, resultClassObject);
        return o;
    }
